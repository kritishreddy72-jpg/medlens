 ...
 */
export function generateSbarReport(patient, readings, conflicts, trends) {
 ...
 */
export function exportToFhirR4(patient, readings, reportTitle = 'Laboratory Diagnostic Report') {
