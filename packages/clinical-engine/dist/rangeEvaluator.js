 ...
 */
export function parseReferenceRangeString(rangeStr) {
 ...
 */
export function evaluateBiomarkerStatus(testName, rawVal, range) {
    ...
    if (nameLower.includes('sodium')) {
        if (numericVal < 120 || numericVal > 158)
            return 'CRITICAL';
    }
    // Interval evaluation
 ...
 */
export function isGatedForReview(reading) {
